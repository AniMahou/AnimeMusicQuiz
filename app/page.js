// app/page.js (simplified with shared Navbar)
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="bg-gradient-to-r from-orange-500 to-pink-600 hover:from-orange-600 hover:to-pink-700 text-white font-semibold px-8 py-3 rounded-lg transition transform hover:scale-105 shadow-lg"
            >
              🎮 Create Lobby
            </button>
            <button
              onClick={handleJoinLobby}
              className="bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white font-semibold px-8 py-3 rounded-lg transition border border-white/20"
            >
              🔑 Join Lobby
            </button>
          </div>
